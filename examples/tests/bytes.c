...
A68_BITS  AGFAAGW_bin(A68_SSBITS  B);

A68_INT  DGFAAGW_abs(A68_SSBITS  B);

A68_CHAR  GGFAAGW_repr(A68_SSBITS  B);

A68_SSBITS  JGFAAGW_bite(A68_BITS  B);

A68_SSBITS  MGFAAGW_bite(A68_INT  I);

A68_SSBITS  PGFAAGW_bite(A68_CHAR  C);

A68_BITS  AGFAAGW_bin(A68_SSBITS  B)
{ 
A68_BITS  BGFAAGW;  /* clause result */
A_PROC_ENTRY(bin);
BGFAAGW = (A68_BITS )(A68_SBITS )B;
A_PROC_EXIT(bin);
return( BGFAAGW );
} 
#undef NL
...
A68_INT  DGFAAGW_abs(A68_SSBITS  B)
{ 
A68_INT  EGFAAGW;  /* clause result */
A_PROC_ENTRY(abs);
EGFAAGW = (A68_INT )AGFAAGW_bin(B);
A_PROC_EXIT(abs);
return( EGFAAGW );
} 
#undef NL
...
A68_CHAR  GGFAAGW_repr(A68_SSBITS  B)
{ 
A68_CHAR  HGFAAGW;  /* clause result */
A_PROC_ENTRY(repr);
HGFAAGW = (A68_SSBITS)DGFAAGW_abs(B);
A_PROC_EXIT(repr);
return( HGFAAGW );
} 
#undef NL
...
A68_SSBITS  JGFAAGW_bite(A68_BITS  B)
{ 
A68_SSBITS  KGFAAGW;  /* clause result */
A_PROC_ENTRY(bite);
KGFAAGW = (A68_SSBITS )(A68_SBITS )B;
A_PROC_EXIT(bite);
return( KGFAAGW );
} 
#undef NL
...
A68_SSBITS  MGFAAGW_bite(A68_INT  I)
{ 
A68_SSBITS  NGFAAGW;  /* clause result */
A_PROC_ENTRY(bite);
NGFAAGW = JGFAAGW_bite((A68_BITS )I);
A_PROC_EXIT(bite);
return( NGFAAGW );
} 
#undef NL
...
A68_SSBITS  PGFAAGW_bite(A68_CHAR  C)
{ 
A68_SSBITS  QGFAAGW;  /* clause result */
A_PROC_ENTRY(bite);
 /* line 16: */
QGFAAGW = MGFAAGW_bite((A68_INT)(unsigned char)C);
A_PROC_EXIT(bite);
return( QGFAAGW );
} 
#undef NL
 /* line 1: */
 /* line 6: */
void WFFAAGW(void)   /* initialise DECS bytes */
{ 
static A68_BOOL A_invoked = A68_FALSE;

/* --- Configuration information for this module */
static char *A_config_arguments[] = {"/usr/bin/a68toc","-s","-v","-lib","/usr/share/algol68toc","-dir","/usr/share/algol68toc","-dir","lib/m","-uname","seedfile","bytes.a68",""};
...
A_config.source_file = "/home/neil/Algol-68RS/algol68toc-1.21/examples/tests/bytes.a68";
A_config.translation_time = "Thu May  6 00:53:43 2021";
A_config.ctrans_version = "Ctrans_34.6";
A_config.name_seed = "VFFAAGW (from seed file) ";
A_config.spec_change_time = "Thu May  6 00:53:43 2021";
A_config.arguments = A_config_arguments;
A_config.environment = A_config_environment;
A_config.modinfo_files = A_config_modinfo_files;
A_PROC_ENTRY(DECS bytes);
 /* line 8: */
 /* line 9: */
 /* line 10: */
 /* line 12: */
 ...
 /* line 14: */
 /* line 25: */
A_PROC_EXIT(DECS bytes);
} 
#undef NL
/* end of translation of bytes.a68 */
